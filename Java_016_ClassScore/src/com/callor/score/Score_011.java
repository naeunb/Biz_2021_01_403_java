...
public class Score_011 {
	public static void main(String[] args) {
		...
		//1차원 배열 ==> 배열을 단순히 나열식으로 만드는것. 연속된 위치에 데이터를 저장.
		//2차원 배열 ==> 배열을 table(표)형식으로 만들어서 가로세로 위치에 데이터를 저장.
		
		//학생수 만큼 세로방향으로 리스트를 만들고 각 리스트는 과목수만큼 배열을 갖는다.
		//int[][] intScore = int[학생수][과목수];
